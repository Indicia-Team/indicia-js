...
(function (global, factory) {
...
}(this, function (_$1, Backbone, LocalForage, $) { 'use strict';
      ...
      value: function _getDriverOrder(driverOrder) {
        return driverOrder.map(function (driver) {
          switch (driver) {
            ...
            default:
              // custom
              if (_typeof(driver) === 'object' && driver._driver) {
    ...
    _syncRemote: function _syncRemote(method, collection, options) {
      ...
      switch (method) {
        case 'create':
          ...
          _$1.each(collection.models, function (model) {
  ...
  var helpers$1 = {
    save: function save(key, val, options) {
      ...
      if (attrs && wait) model.attributes = _$1.extend({}, attributes, attrs);
      var method = 'create';
  ...
  var Media = Backbone.Model.extend({
    constructor: function constructor() {
      ...
      attrs = _$1.defaults({}, attrs, _$1.result(this, 'defaults'));
    ...
    validateRemote: function validateRemote(attributes) {
      var attrs = _$1.extend({}, this.attributes, attributes);
  ...
  _$1.extend(Media.prototype, helpers$1);
  ...
  var Occurrence = Backbone.Model.extend({
    ...
    constructor: function constructor() {
      ...
      if (options.media) {
        ...
        _$1.each(options.media, function (media) {
          if (media instanceof _this.Media) {
            media.setParent(that);
            mediaArray.push(media);
          } else {
            var modelOptions = _$1.extend(media, {
              parent: that
            });
    ...
    validateRemote: function validateRemote(attributes) {
      ...
      if (!_$1.isEmpty(media)) {
        errors.media = media;
      }

      if (!_$1.isEmpty(modelErrors)) {
    ...
    _getSubmission: function _getSubmission() {
      ...
      var media = _toConsumableArray(this.media.models); // all media within this and child models
      ...
      var _this$media$_getSubmi = this.media._getSubmission(),
          _this$media$_getSubmi2 = _slicedToArray(_this$media$_getSubmi, 1),
  ...
  _$1.extend(Occurrence.prototype, helpers$1);
  /**
  ...
  var Sample = Backbone.Model.extend({
    ...
    constructor: function constructor() {
      ...
      var attrs = _$1.extend(defaultAttrs, attributes);
    ...
    validateRemote: function validateRemote(attributes) {
      ...
      if (!_$1.isEmpty(occurrences)) {
        errors.occurrences = occurrences;
      }

      if (!_$1.isEmpty(samples)) {
    ...
    _getSubmission: function _getSubmission() {
      ...
      var sampleOptions = _$1.extend({}, options);
      ...
      var _this$occurrences$_ge = this.occurrences._getSubmission(sampleOptions),
          _this$occurrences$_ge2 = _slicedToArray(_this$occurrences$_ge, 2),
      ...
      var _this$samples$_getSub = this.samples._getSubmission(sampleOptions),
          _this$samples$_getSub2 = _slicedToArray(_this$samples$_getSub, 2),
    ...
    _parseModels: function _parseModels(models, Model) {
      ...
      _$1.each(models, function (model) {
        if (model instanceof Model) {
          model.setParent(that);
          modelsArray.push(model);
        } else {
          var modelOptions = _$1.extend(model, {
            parent: that
          });
  ...
  _$1.extend(Sample.prototype, helpers$1);
  /**
   * Warehouse attributes and their values.
   */
